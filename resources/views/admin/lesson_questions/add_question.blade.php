@extends('layouts.admin',['page' => __('Lesson Questions'), 'pageSlug' => 'lesson_questions'])
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="card card-custom card-stretch gutter-b">
						...
						<!--begin::Body-->
						 <!--begin::Form-->
						 <form action="{{ route('lesson_questions.store')}}" method="post" enctype="multipart/form-data">
						 	@csrf
						  <div class="card-body">

			 ...
			 <form action="{{ route('units.store')}}" method="post">
			  ...
			  <div class="card-body">
			   <div class="form-group">
			    <label>Sort</label>
			    <input type="number" class="form-control"  placeholder="Enter Sort" name="unit_sort" value="{{old('unit_sort')}}">
			   </div>
			   <div class="form-group">
			    <label>Unit</label>
			    <input type="text" class="form-control"  placeholder="Enter Unit" name="unit_name" value="{{old('unit_name')}}">
			   </div>
			   <div class="form-group">
			    <label>Level</label>
